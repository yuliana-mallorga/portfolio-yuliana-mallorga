...
function Navbar() {
    return (
        <div className="min-h-screen overflow-hidden flex items-center justify-items-stretch">
            <nav className="bg-gray-500 shadow shadow-gray-300 w-100 px-8 md:px-auto">
                <div className="md:h-16 h-28 mx-auto md:px-4 container flex items-center justify-between flex-wrap md:flex-nowrap">
                    ...
                    <div className="text-gray-500 order-3 w-full md:w-auto md:order-2">
                        <ul classNames="flex font-semibold justify-between">
